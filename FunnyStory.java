...
public class FunnyStory {
    public static void main(String[] args) {
        ...
        String[] actions = {"discovered a hidden treasure", "annoy eachother", "built a time machine", "found an alien", "became a superhero"};
        String[] twists = {"but suddenly disappeared", "but it was all a dream", "and saved the world", "and accidentally started a time loop", "and met a talking cat"};
